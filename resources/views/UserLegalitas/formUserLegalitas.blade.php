<x-app>
    ...
    <div class="min-h-screen bg-[#f7f7f7] inset-0">
        ...
        <main class="bg-[#f7f7f7] min-h-screen w-full py-10 px-4 sm:px-6 lg:px-8">
            <form action="{{ route('store.legalitas.form') }}" method="post">
                @csrf
                <div class="bg-white rounded-xl border border-[#918e8a] w-full mx-auto p-8 shadow-lg">
                    ...
                    <div class="mb-8">
                        ...
                        <p class="text-sm text-gray-600 mb-6">Masukkan nama usaha yang ingin Anda daftarkan untuk
                            mendapatkan rekomendasi legalitas yang sesuai.</p>
                        <input type="text" id="nama_usaha" name="nama_usaha" value="{{ old('nama_usaha') }}"
                            {{-- Menjaga nilai input setelah validasi gagal --}} required maxlength="255" {{-- Validasi sisi klien --}}
                            class="w-full border
                    {{ $errors->has('nama_usaha') ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-[#1b5a4f]' }}
                    rounded-lg px-4 py-2 focus:outline-none focus:ring-2 transition" />
                        @error('nama_usaha')
                    ...
                    <div class="mb-8">
                        ...
                        <p class="text-sm text-gray-600 mb-3">Pilih bentuk usaha Anda agar kami dapat memberikan jenis
                            legalitas yang tepat.</p>
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 pt-4">
                            <div class="flex flex-col items-center w-full">
                                <label
                                    class="group cursor-pointer w-full max-w-xs flex items-center justify-center transition-all">
                                    <input type="radio" name="tipe" value="UMKM" class="peer hidden"
                                        {{ old('tipe') == 'UMKM' ? 'checked' : '' }} />
                                    <div
                                        class="flex flex-col items-center border-4 rounded-lg p-4 w-full h-full hover:border-[#1b5a4f]
                            {{ $errors->has('tipe') ? 'border-red-500 peer-checked:border-red-500 text-red-500 peer-checked:text-red-500' : 'border-gray-500 peer-checked:border-[#1b5a4f] text-gray-500 peer-checked:text-[#1b5a4f]' }}
                            group-hover:text-[#1b5a4f] transition-all">
                                        <svg class="w-16 h-16 fill-current transition-colors duration-200"
                                            fill="currentColor" version="1.1" id="Layer_1"
                                            xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 415.453 415.453"
                                            xml:space="preserve">
                                            ...
                                            <g id="SVGRepo_iconCarrier">
                                                ...
                                                <g>
                                                    <g>
                                                        <path
                                                            d="M142.354,227.09H84.49c-4.142,0-7.5,3.358-7.5,7.5v134.136c0,4.142,3.358,7.5,7.5,7.5h57.864c4.142,0,7.5-3.358,7.5-7.5 V234.59C149.854,230.448,146.496,227.09,142.354,227.09z M134.854,361.226H91.99V242.09h42.864V361.226z">
                                                        </path>
                                                    </g>
                                                </g>
                                                <g>
                            ...
                            <div class="flex flex-col items-center w-full">
                                <label
                                    class="group cursor-pointer w-full max-w-xs flex items-center justify-center transition-all">
                                    <input type="radio" name="tipe" value="CV" class="peer hidden"
                                        {{ old('tipe') == 'CV' ? 'checked' : '' }} />
                                    <div
                                        class="flex flex-col items-center border-4 rounded-lg p-4 w-full h-full hover:border-[#1b5a4f]
                            {{ $errors->has('tipe') ? 'border-red-500 peer-checked:border-red-500 text-red-500 peer-checked:text-red-500' : 'border-gray-500 peer-checked:border-[#1b5a4f] text-gray-500 peer-checked:text-[#1b5a4f]' }}
                            group-hover:text-[#1b5a4f] transition-all">
                                        <svg class="w-16 h-16 fill-current transition-colors duration-200"
                                            fill="currentColor" height="200px" width="200px" version="1.1"
                            ...
                            <div class="flex flex-col items-center w-full">
                                <label
                                    class="group cursor-pointer w-full max-w-xs flex items-center justify-center transition-all">
                                    <input type="radio" name="tipe" value="PT" class="peer hidden"
                                        {{ old('tipe') == 'PT' ? 'checked' : '' }} />
                                    <div
                                        class="flex flex-col items-center border-4 rounded-lg p-4 w-full h-full hover:border-[#1b5a4f]
                            {{ $errors->has('tipe') ? 'border-red-500 peer-checked:border-red-500 text-red-500 peer-checked:text-red-500' : 'border-gray-500 peer-checked:border-[#1b5a4f] text-gray-500 peer-checked:text-[#1b5a4f]' }}
                                        ...
                                        <svg class="w-16 h-16 fill-current transition-colors duration-200"
                                            ...
                                            <g id="SVGRepo_iconCarrier">
                                                ...
                                                <g>
                                                    <g>
                                                        <path
                                                            d="M76.426,376.251H42.221c-4.428,0-8.017,3.588-8.017,8.017v34.205c0,4.428,3.588,8.017,8.017,8.017h34.205 c4.428,0,8.017-3.588,8.017-8.017v-34.205C84.443,379.839,80.854,376.251,76.426,376.251z M68.409,410.455H50.238v-18.171h18.171 V410.455z">
                                                        </path>
                                                    </g>
                                                </g>
                                                <g>
                                                    <g>
                                                        <path
                                                            d="M469.779,376.251h-34.205c-4.428,0-8.017,3.588-8.017,8.017v34.205c0,4.428,3.588,8.017,8.017,8.017h34.205 c4.428,0,8.017-3.588,8.017-8.017v-34.205C477.795,379.839,474.207,376.251,469.779,376.251z M461.762,410.455h-18.171v-18.171 h18.171V410.455z">
                                                        </path>
                                                    </g>
                                                </g>
                                                <g>
                                                    <g>
                                                        <path
                                                            d="M273.102,376.251h-34.205c-4.428,0-8.017,3.588-8.017,8.017v34.205c0,4.428,3.588,8.017,8.017,8.017h34.205 c4.428,0,8.017-3.588,8.017-8.017v-34.205C281.119,379.839,277.531,376.251,273.102,376.251z M265.086,410.455h-18.171v-18.171 h18.171V410.455z">
                                                        </path>
                                                    </g>
                                                </g>
                                                <g>
                                                    <g>
                                                        <path
                                                            d="M375.716,376.251h-34.205c-4.428,0-8.017,3.588-8.017,8.017v34.205c0,4.428,3.588,8.017,8.017,8.017h34.205 c4.428,0,8.017-3.588,8.017-8.017v-34.205C383.733,379.839,380.145,376.251,375.716,376.251z M367.699,410.455h-18.171v-18.171 h18.171V410.455z">
                                                        </path>
                                                    </g>
                                                </g>
                                                <g>
                                                    <g>
                                                        <path
                                                            d="M170.489,376.251h-34.205c-4.428,0-8.017,3.588-8.017,8.017v34.205c0,4.428,3.588,8.017,8.017,8.017h34.205 c4.428,0,8.017-3.588,8.017-8.017v-34.205C178.505,379.839,174.917,376.251,170.489,376.251z M162.472,410.455h-18.171v-18.171 h18.171V410.455z">
                                                        </path>
                                                    </g>
                                                </g>
                                                <g>
                                                    <g>
                                                        <path
                                                            d="M76.426,436.109H42.221c-4.428,0-8.017,3.588-8.017,8.017v34.205c0,4.428,3.588,8.017,8.017,8.017h34.205 c4.428,0,8.017-3.588,8.017-8.017v-34.205C84.443,439.697,80.854,436.109,76.426,436.109z M68.409,470.313H50.238v-18.171h18.171 V470.313z">
                                                        </path>
                                                    </g>
                                                </g>
                                                <g>
                                                    <g>
                                                        <path
                                                            d="M469.779,436.109h-34.205c-4.428,0-8.017,3.588-8.017,8.017v34.205c0,4.428,3.588,8.017,8.017,8.017h34.205 c4.428,0,8.017-3.588,8.017-8.017v-34.205C477.795,439.697,474.207,436.109,469.779,436.109z M461.762,470.313h-18.171v-18.171 h18.171V470.313z">
                                                        </path>
                                                    </g>
                                                </g>
                                                <g>
                                                    <g>
                                                        <path
                                                            d="M273.102,436.109h-34.205c-4.428,0-8.017,3.588-8.017,8.017v34.205c0,4.428,3.588,8.017,8.017,8.017h34.205 c4.428,0,8.017-3.588,8.017-8.017v-34.205C281.119,439.697,277.531,436.109,273.102,436.109z M265.086,470.313h-18.171v-18.171 h18.171V470.313z">
                                                        </path>
                                                    </g>
                                                </g>
                                                <g>
                                                    <g>
                                                        <path
                                                            d="M375.716,436.109h-34.205c-4.428,0-8.017,3.588-8.017,8.017v34.205c0,4.428,3.588,8.017,8.017,8.017h34.205 c4.428,0,8.017-3.588,8.017-8.017v-34.205C383.733,439.697,380.145,436.109,375.716,436.109z M367.699,470.313h-18.171v-18.171 h18.171V470.313z">
                                                        </path>
                                                    </g>
                                                </g>
                                                <g>
                                                    <g>
                                                        <path
                                                            d="M170.489,436.109h-34.205c-4.428,0-8.017,3.588-8.017,8.017v34.205c0,4.428,3.588,8.017,8.017,8.017h34.205 c4.428,0,8.017-3.588,8.017-8.017v-34.205C178.505,439.697,174.917,436.109,170.489,436.109z M162.472,470.313h-18.171v-18.171 h18.171V470.313z">
                                                        </path>
                                                    </g>
                                                </g>
                                                <g>
                    ...
                    <div class="mb-8">
                        ...
                        <p class="text-sm text-gray-600 mb-6">Tentukan bagaimana usaha Anda beroperasi. Apakah
                            memproduksi barang sendiri, menjadi distributor, atau memberikan layanan/jasa.</p>
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            <label class="group">
                                <input type="radio" name="model" value="Produksi Sendiri" class="peer hidden"
                                    {{ old('model') == 'Produksi Sendiri' ? 'checked' : '' }} />
                                <div
                                    class="flex items-start gap-2 cursor-pointer border rounded-lg p-4 hover:bg-[#1b5a4f] hover:text-gray-100
                        {{ $errors->has('model') ? 'border-red-500 peer-checked:border-red-500 text-red-500 peer-checked:text-red-500' : 'border-gray-300 peer-checked:bg-[#1b5a4f] peer-checked:text-gray-100' }}
                        transition-colors duration-200">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs group-hover:text-gray-100 text-inherit">Usaha membuat dan
                                            menjual produk sendiri.</p> {{-- Perbaikan deskripsi --}}
                                    </div>
                                </div>
                            </label>
                            <label class="group">
                                <input type="radio" name="model" value="Distributor" class="peer hidden"
                                    {{ old('model') == 'Distributor' ? 'checked' : '' }} />
                                <div
                                    class="flex items-start gap-2 cursor-pointer border rounded-lg p-4 hover:bg-[#1b5a4f] hover:text-gray-100
                        {{ $errors->has('model') ? 'border-red-500 peer-checked:border-red-500 text-red-500 peer-checked:text-red-500' : 'border-gray-300 peer-checked:bg-[#1b5a4f] peer-checked:text-gray-100' }}
                        transition-colors duration-200">
                                    <div class="text-2xl mt-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <rect x="1" y="3" width="15" height="15" rx="2"
                                                ry="2"></rect>
                                            <path d="M16 8h4l3 3v7h-3"></path>
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs group-hover:text-gray-100 text-inherit">Usaha menjual produk
                                            pihak lain.</p>
                                    </div>
                                </div>
                            </label>
                            <label class="group">
                                <input type="radio" name="model" value="Jasa/Layanan" class="peer hidden"
                                    {{ old('model') == 'Jasa/Layanan' ? 'checked' : '' }} />
                                <div
                                    class="flex items-start gap-2 cursor-pointer border rounded-lg p-4 hover:bg-[#1b5a4f] hover:text-gray-100
                        {{ $errors->has('model') ? 'border-red-500 peer-checked:border-red-500 text-red-500 peer-checked:text-red-500' : 'border-gray-300 peer-checked:bg-[#1b5a4f] peer-checked:text-gray-100' }}
                        transition-colors duration-200">
                                    <div class="text-2xl mt-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <rect x="2" y="7" width="20" height="14" rx="2"
                                                ry="2"></rect>
                                            <path d="M16 21V7a2 2 0 0 0-2-2H10a2 2 0 0 0-2 2v14"></path>
                                        </svg>
                                    </div>
                                    <div>
                                        <div class="font-semibold text-inherit">Jasa/Layanan</div>
                                        <p class="text-xs group-hover:text-gray-100 text-inherit">Usaha yang
                                            menyediakan layanan atau jasa.</p>
                                    </div>
                                </div>
                            </label>
                        </div>
        ...
        {{ $errors->has('sektor') ? 'text-red-600' : 'text-gray-900' }}">
                            Bidang Usaha
                        </label>
                        ...
                        <p class="text-sm text-gray-600 mb-6">
                            Pilih kategori utama dari usaha Anda, seperti kuliner, fashion, teknologi, pertanian, dan
                            lainnya.
                            Ini akan membantu kami memahami fokus bisnis Anda.
                        </p>

                        <select id="sektor" name="sektor"
                            class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring-2
        {{ $errors->has('sektor') ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-[#1b5a4f]' }}">
                    ...
                    <div class="flex justify-end mt-8">
                        <button type="submit"
                            class="px-6 py-3 bg-[#1b5a4f] text-white font-semibold rounded-lg shadow-md hover:bg-[#15463b] focus:outline-none focus:ring-2 focus:ring-[#1b5a4f] focus:ring-opacity-75 transition duration-200">
